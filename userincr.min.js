(function(d){d.fn.userincr=function(c){c=d.extend({},d.fn.userincr.defaults,c||{});return this.each(function(){var b=d(this);b.data("value",c.value||b.data("value")||b.val()||0);b.val(b.data("value"));d.each(["min","max","step","op","previos"],function(a,e){void 0!==c[e]&&b.data(e,c[e])});var h="b";b.attr("title",b.attr("title")||'Enter "+x" or "+x%" or "*x" \nto change increment'+d.map(c.constants,function(a,b){return"\n"+b+"="+a}).join("")).on("change",function(a){a=b.val();if(void 0!==c.constants[a])b.val(c.constants[a]);
